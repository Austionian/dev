...
vim.g.have_nerd_font = false -- I do, just distracting more than helpful
...
vim.keymap.set('n', 'J', 'mzJ`z', { desc = 'Remove new line' })

vim.keymap.set('n', '<leader><leader>', '<c-^>', { desc = 'toggle back to last buffer' })
...
vim.keymap.set('n', '<leader>o', ':e <C-R>=expand("%:p:h") . "/" <cr>', { desc = 'open new file adjacent to current file' })
